const PricingSection = () => {
  return (
    <section className="w-full bg-[#FFFFFF] flex items-center justify-center" style={{ height: '830px' }}>
      <div className="w-full px-6 flex flex-col items-center justify-center" style={{ maxWidth: '1200px' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full items-stretch">
          ...
          <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm flex flex-col justify-between h-[520px]">
            <div>
            ...
            <button className="w-full py-3 bg-[#7C3AED] hover:bg-[#6D28D9] text-white rounded-xl font-semibold text-sm shadow-sm transition-colors duration-200 cursor-pointer">
              Get Started Free
            </button>
          </div>

          <div className="bg-[#7C3AED] rounded-2xl p-8 shadow-md flex flex-col justify-between h-[540px] relative -mt-2 border border-[#7C3AED]">
            ...
            <div>
              ...
              <ul className="space-y-3.5">
                <li className="text-[13px] text-white flex items-start gap-2.5">
                  <svg className="w-4 h-4 text-white mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                  </svg>
            ...
            <button className="w-full py-3 bg-white hover:bg-gray-50 text-[#7C3AED] rounded-xl font-semibold text-sm shadow-sm transition-colors duration-200 cursor-pointer">
              Start Pro Trial
            </button>
          </div>
